...
if (isset($_GET['delete_id'])) {
  ...
  $sql = "DELETE FROM users WHERE id_user = $delete_id";
    ...
    <div class="page my-3" id="welcome">
      <div class="row align-items-center">
        <div class="col-md-6 d-flex justify-content-start">
            <h1 class="text-center p-3 ps-5 fs-1">Manage Users</h1>
        </div>
        <div class="col-md-6">
            <div class="row justify-content-end">
                <div class="col-md-6 fs-3 p-3 d-flex align-items-center justify-content-end">
                    ...
                    <a class="btn btn-success me-4" href="user/createUser.php">Add New User</a>
                </div>
            </div>
        </div>
      </div>
