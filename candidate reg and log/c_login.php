...
<body>
    <div class="login">
        ...
        <form action="dbh/c-login.php" method="post">
            <h1>LOG IN</h1>
            <label>Email</label>
            ...
            <label class="login-register">
                <div class="button-container">
                    Don't have an account?<a href="c_register.html">Register</a>
                </div>
            </label>
            <label>
                <div class="button-container">
                    Forgot password?<a href="c_forgot.html">Reset</a>
                </div>
            </label>
        </form>
        <img src="../img/c_login.jpg" alt="login img">
    </div>
</body>
